...
const projectsPageTexts = {
  sq: {
    badge: "PORTFOLI",
    title: "Të Gjitha Projektet",
    description:
      "Zbuloni portofolin tonë të plotë të projekteve moderne të inxhinierisë dhe konstruksioneve metalike, të realizuara me precizitet, inovacion dhe standarde të larta industriale.",
    stats: {
      completedProjects: "Projekte të Përfunduara",
      clientSatisfaction: "Kënaqësi e Klientëve",
      yearsExperience: "Vite Përvojë",
    },
    showing: "Shfaqur",
    projects: "Projekte",
    updatedPortfolio: "Portofol i Përditësuar",
  },
  en: {
    badge: "PORTFOLIO",
    title: "All Projects",
    description:
      "Discover our complete portfolio of modern engineering and metal construction projects, delivered with precision, innovation, and high industrial standards.",
    stats: {
  ...
  mk: {
    ...
    title: "Сите проекти",
    description:
      "Откријте го нашето целосно портфолио на модерни инженерски и метални конструкциски проекти, реализирани со прецизност, иновација и високи индустриски стандарди.",
    stats: {
      completedProjects: "Завршени проекти",
      clientSatisfaction: "Задоволство на клиенти",
      yearsExperience: "Години искуство",
    },
    showing: "Прикажани",
    projects: "Проекти",
    updatedPortfolio: "Ажурирано портфолио",
  },
  de: {
    badge: "PORTFOLIO",
    title: "Alle Projekte",
    description:
      "Entdecken Sie unser vollständiges Portfolio moderner Ingenieur- und Metallbauprojekte, umgesetzt mit Präzision, Innovation und hohen Industriestandards.",
    stats: {
    ...
    showing: "Angezeigt",
    projects: "Projekte",
    updatedPortfolio: "Aktualisiertes Portfolio",
  },
};
...
const ProjectsPage = () => {
  ...
  const t = projectsPageTexts[currentLocale];

  const stats = [
    { value: "500+", label: t.stats.completedProjects },
    { value: "99%", label: t.stats.clientSatisfaction },
    { value: "23+", label: t.stats.yearsExperience },
  ];
