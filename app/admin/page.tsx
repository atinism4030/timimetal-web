      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div>
            ...
            <h1 className="text-4xl font-bold text-[#0a0e1a]">
              Project Management
            </h1>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-20 shadow-xl border border-[#E8F3FF] text-center">
            ...
            <h2 className="text-2xl font-semibold text-[#0a0e1a] mb-2">
              No Projects Found
            </h2>
            <p className="text-[#5A6675] mb-8">
              ...
              >
                ...
                <div className="flex-grow min-w-0 px-2">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-[#5A6675] font-medium">
                      {project.date}
                    </span>
                  </div>
                  <h3 className="text-xl font-bold text-[#0a0e1a] mb-2 truncate">
                    {project.title}
                  </h3>
